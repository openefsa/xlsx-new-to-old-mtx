...
/**
 * This class takes as input the new xlsx format file for the Foodex catalogue
 * and converts it to recreate the old Foodex xlsx export (for compatibility
 * issues).
 * 
 * @author avonva
 *
	...
	public void convert() throws Exception {
		...
		if (progressBar != null) {
			progressBar.setLabel(
					"Converting " + Headers.TERM_SHEET_NAME + " sheet into " + OldHeaders.DATA_SHEET_NAME + " sheet");
		...
		if (progressBar != null) {
			progressBar.setLabel(
					"Converting " + Headers.ATTR_SHEET_NAME + " sheet into " + OldHeaders.ATTR_SHEET_NAME + " sheet");
